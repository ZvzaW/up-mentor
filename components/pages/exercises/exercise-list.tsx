...
export function ExerciseList({
  ...
  return (
    <>
      <Card>
        <CardContent>
        <div className="flex flex-col gap-4 sm:flex-row items-center mb-8">
        <div className="w-full" >
            ...
            <Input
              ...
              className=" border rounded-full  placeholder:text-zinc-400 placeholder:text-xs"
            />
          </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <div className="mb-4 flex flex-wrap items-center gap-x-3 gap-y-1">
                          ...
                          <span className="shrink-0 rounded-full border border-baby-blue/40 px-2 pb-0.5 pt-1 text-xs text-zinc-300">
                        ...
                        <div className="space-y-3"> 
                          ...
                          Partia ciała:{" "}
                          <span className="text-zinc-200">{ex.body_part}</span>
                        </p>
